  ...
  return (
    <Layout>
      <Section>
        ...
        <span>Effective date: 2022-07-01</span>
        <div className='my-3'>
          <List>
            <li className='border-bottom'>
              <span className='mb-2'>Introduction</span>
              <p>
                Welcome to <b>Spid Realty Ltd.</b> Spid Realty Ltd (“us”, “we”,
                or “our”) operates <b>spidrealty.com</b> (hereinafter referred
                to as “Service”). Our Privacy Policy governs your visit to
                <b> spidrealty.com</b>, and explains how we collect, safeguard
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Definitions</span>
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>service</h6> means the
                spidrealty.com website operated by Spid Realty Ltd.
              </div>
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>personal data </h6> means
              ...
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>cookies</h6> are small files
                stored on your device (computer or mobile device).
              </div>
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>data controller</h6> means a
              ...
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>data subject</h6> is any
                living individual who is the subject of Personal Data.
              </div>
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>the user</h6> is the
                individual using our Service. The User corresponds to the Data
                Subject, who is the subject of Personal Data.
              </div>
            </li>
            <li className='border-bottom'>
              <span className='mb-2'>Information Collection and Use</span> We
              collect several different types of information for various
              purposes to provide and improve our Service to you.
            </li>
            <li className='border-bottom'>
              <span className='mb-2'>Types of Data Collected</span>{" "}
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>Personal Data</h6> While
                ...
                or identify you ("<b>Personal Data</b>"). Personally
                identifiable information may include, but is not limited to:
                <p className='m-0'>0.1. Email address</p>
                <p className='m-0'>0.2. First name and last name</p>
                <p className='m-0'>0.3. Phone number</p>
                <p className='m-0'>
                  0.4. Address, Country, State, Province, ZIP/Postal code, City
                </p>
                <p className='m-0'>0.5. Cookies and Usage Data</p>
                <p>
              ...
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>Usage Data</h6> We may also
                collect information that your browser sends whenever you visit
                our Service or when you access the Service by or through any
              ...
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>Tracking Cookies Data</h6> We
              ...
              <div className='mb-2'>
                <h6 className='m-0 d-inline-block'>Other Data</h6> While using
                our Service, we may also collect the following information: sex,
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Use of Data</span>
              <p>
                Spid Realty Ltd uses the collected data for various purposes:
              </p>
              <p className='m-0'>0.1. to provide and maintain our Service;</p>
              <p className='m-0'>
              ...
              <p className='m-0'>0.4. to provide customer support;</p>
              <p className='m-0'>
                0.5. to gather analysis or valuable information so that we can
                improve our Service;
              </p>
              <p className='m-0'>0.6. to monitor the usage of our Service;</p>
              <p className='m-0'>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Retention of Data</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Transfer of Data</span>
              <p>
              ...
              <p>
                Spid Realty Ltd will take all the steps reasonably necessary to
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Disclosure of Data</span>
              <p>
              ...
              <p className='m-0'>
                0.1. Business Transaction. If we or our subsidiaries are
              ...
              <p className='m-0'>0.2.1. to our subsidiaries and affiliates;</p>
              <p className='m-0'>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Security of Data</span>
              <p>
            ...
            <li className='border-bottom'>
              ...
              <p>
                ...
                us at <b>support@spidrealty.com</b>.
              </p>
              <p>
            ...
            <li className='border-bottom'>
              ...
              <p className='m-0'>0.1. users can visit our site anonymously;</p>
              <p className='m-0'>
              ...
              <p className='m-0'>
                ...
                emailing us at <b>support@spidrealty.com</b>.
              </p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Service Providers</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>CI/CD tools</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Behavioral Remarketing</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Payments</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Links to Other Sites</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Children’s Privacy</span>
              <p>
            ...
            <li className='border-bottom'>
              <span className='mb-2'>Changes to This Privacy Policy</span>
              <p>
            ...
            <li>
              ...
              <p>
                ...
                contact us by email:{" "}
                <a href='mailto:support@spidrealty.com'>
                  support@spidrealty.com
                </a>
              </p>
            </li>
          </List>

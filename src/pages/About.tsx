      ...
      <div className='bg-light'>
        <Section>
          ...
          <p>
            ...
            marketing and sales goals while ensuring that our clients are happy
            and fulfilled through making secured purchases on our platform.
          </p>
          <p>
            ...
            <div className='row justify-content-start'>
              ...
              <div className='col-lg-6'>
                <p>
                  ...
                  eos consequatur blanditiis at deleniti enim doloremque
                  quisquam neque eveniet repellendus? Assumenda, beatae nam!
                </p>

                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Dolore laboriosam consequuntur et dolorum, debitis, doloribus
                  inventore praesentium unde explicabo rerum est, aspernatur
                  vero? Et maiores quaerat qui unde blanditiis commodi. Lorem
                  ipsum dolor sit, amet consectetur adipisicing elit. Dicta
                  totam voluptates in, voluptatibus, animi qui quisquam
                  voluptatum quis, vero porro neque error libero dolorum
                  officiis. Recusandae accusamus quibusdam ducimus quaerat.
                </p>
              </div>
            </div>
          </div>
          <div className='my-3'>
            ...
            <List>
              <li>
                <span>Property Availability Assurance </span> We use
                cutting-edge technology to check and double-check listings from
                our agents and partner companies to ensure that you access the
                most trusted, accurate property listings available anywhere.
              </li>
              <li>
                <span>New Property Listing</span> We are obsessed with providing
                the freshest listings because timing and accuracy mean
                everything when it comes to buying property. You can easily find
                the newest properties right here at Spideealty.com with the
                click of a button.
              </li>
              <li>
                ...
                property. In addition to helpful information, laws and
                educational articles, our FREE property email alerts can deliver
                listings directly to your inbox so that you can learn about
                great deals in your area without even searching.
              </li>
              <li>
                <span>Seamless Search and Navigation </span> Spidrealty.com has
                an interface that is easy to search and navigate. You can search
